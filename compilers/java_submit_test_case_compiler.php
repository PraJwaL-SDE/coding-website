...
if ($returnCode === 0 && $returnCode2 === 0) {
    ...
    for ($i = 1; $i <= 6; $i++) {
        // Construct the custom test case
        $customTestCase = $testCases["testCase$i"];
...
file_put_contents("output.txt", "<div style='background-color: #f0f0f0; padding: 20px; border-radius: 5px;'><h2 style='color: green;'>All test cases passed successfully!</h2><p style='color: blue;'>Congratulations! Your code is working perfectly.</p></div>");
